    ...
    <div className="relative w-full h-[110vh] sm:h-screen bg-[url('/images/bg.png')] bg-cover bg-center flex justify-center flex-col">
      <div className='w-[90%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10'>
        ...
        <div data-aos="fade-up">
          <p  className='text-sm sm:text-base ms:text-xl font-bold text-blue-950'>
            make the Smartest investment
          </p>
          <h1 className='text-2xl ms:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950 leading-[2.5rem] md:leading-[]3.5rem'>Kickstart, Scale, and Thrive Faster With{ " "} <span className='text-rose-700'>Gandom Accounting</span></h1>
          <p className='text-xs sm:text-sm md:text-base font-medium text-gray-700'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione assumenda minus placeat quia laudantium fugit magni iusto accusantium, corrupti, ex animi distinctio soluta neque, nemo nobis! Delectus voluptates officiis temporibus!
          </p>
          {/* Rating */}
          <div className='flex sm:flex-row flex-col sm:items-center sm:space-x-10 mt-6 items-center'>
            ...
            <div>
              <div className='flex items-center space-x-2'>
                ...
                <div className='flex items-center'>
                  <FaStar className='2-4 h-4 text-yellow-500' />
                  <FaStar className='2-4 h-4 text-yellow-500' />
                  <FaStar className='2-4 h-4 text-yellow-500' />
                  <FaStar className='2-4 h-4 text-yellow-500' />
                  <BsStarHalf className='2-4 h-4 text-yellow-500' />
                </div>
              </div>
          ...
          <div className='flex flex-col sm:flex-row items-center sm:space-x-8 lg:space-x-12'>
            <div className='mt-8 flex flex-col sm:flex-row w-fit sm:items-center spqce-y-4 sm:space-y-0 sm:space-x-4'>
